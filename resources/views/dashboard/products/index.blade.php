            ...
            <div class="box box-primary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            @if (auth()->user()->hasPermission('delete-' . $module_name_plural))
                                <form method="post" action="{{ route('dashboard.' . $module_name_plural . '.bulk_delete') }}"
                                    style="display: inline-block;">
                                    @csrf
                                    @method('delete')
                                    <input type="hidden" name="record_ids" id="record-ids">
                                    <button type="submit" class="btn btn-danger delete" id="bulk-delete" disabled="true"><i
                                            class="fa fa-trash"></i> @lang('site.bulk_delete')</button>
                                </form><!-- end of form -->
                            @endif
                            <form action="{{ route('dashboard.' . $module_name_plural . '.store_excel') }}" method="POST"
                                enctype="multipart/form-data" style="display: inline-block;">
                                {{ method_field('post') }}
                                {{ csrf_field() }}
                                <input type="file" name="excel" class="form-control"
                                    style="width: auto !important; display:inline-block">
                                <button type="submit" class="btn btn-success" style="display: inline"><i class="fa fa-file-excel-o" aria-hidden="true"></i> import excel</button>

                            </form>



                            <a href="{{ route('dashboard.' . $module_name_plural . '.export') }}" class="btn btn-success"
                                class="d-inline-block"><i class="fa fa-file-excel-o" aria-hidden="true"></i> export</a>
                        </div>
                    </div>
                ...
                <div class="box-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-hover datatable" id="{{ $module_name_plural }}-table"
